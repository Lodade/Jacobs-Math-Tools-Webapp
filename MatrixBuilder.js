var matrixBuilder = function(){
	...
	return {
		...
		buildInitialMatrices: function() {
			...
			this.buildResultMatrix();
		},
		buildResultMatrix: function() {
...
var mainInstance = matrixBuilder();
mainInstance.gatherMatrixElements();
mainInstance.buildInitialMatrices();
mainInstance.buildResultMatrix();